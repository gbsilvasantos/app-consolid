...
class DetalhesPessoasModel extends FlutterFlowModel {
  ...
  // Stores action output result for [Backend Call - API (addFaceID)] action in CircleImage widget.
  ApiCallResponse? apiResultrjn;
